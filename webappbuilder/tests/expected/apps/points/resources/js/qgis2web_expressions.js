...
function pointsrule0_eval_expression(context) {
    // n = 2
...
function pointsrule1_eval_expression(context) {
    // n = 3
...
function pointsrule2_eval_expression(context) {
    // n = 4
...
function pointsrule3_eval_expression(context) {
    // n = 5
...
function pointsrule4_eval_expression(context) {
    // n = 6
...
function pointsrule5_eval_expression(context) {
    // n = 7
...
function pointsrule6_eval_expression(context) {
    // n = 8
...
function pointsrule7_eval_expression(context) {
    // n = 9
...
function pointsrule8_eval_expression(context) {
    // n = 10
...
function pointsrule9_eval_expression(context) {
    // n = 11
...
function pointsrule10_eval_expression(context) {
    // n = 12
...
function pointsrule11_eval_expression(context) {
    // n = 13
...
function pointsrule12_eval_expression(context) {
    // n = 14
...
function pointsrule13_eval_expression(context) {
    // n = 15
...
function pointsrule14_eval_expression(context) {
    // n = 16
...
function pointsrule16_eval_expression(context) {
    // n > 50 AND n / 10 - round(n / 10) = 0
...
function size_dd_expression694735488896353489_eval_expression(context) {
    ...
    return fnc_x([fnc__geometry([[]], context)], context);
}
...
function pointsrule17_eval_expression(context) {
    // n > 50 AND right(to_string(n), 1) = '4'
...
function pointsrule18_eval_expression(context) {
    // n = 58
...
function pointsrule19_eval_expression(context) {
    // n = 88
