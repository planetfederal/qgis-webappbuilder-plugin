...
function label_expression_eval_expression(context) {
    // concat('Size:', to_string(size))

    var feature = context.feature;
    
    return fnc_concat(['Size:',fnc_to_string([feature.get('size') ], context)], context);
}


function fontsize6474694455820877616_eval_expression(context) {
    // size
