...
class Help(WebAppWidget):
    ...
    def write(self, appdef, folder, app, progress):
        ...
        app.tools.append('''<ul className='pull-right' id='toolbar-help'><BUTTON.DefaultButton onClick={function(){window.open('help/help.html','_blank')}} title='Help'><ICON.Icon name='help' /> Help</BUTTON.DefaultButton></ul>''')
