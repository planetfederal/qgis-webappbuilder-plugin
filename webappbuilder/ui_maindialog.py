...
#
# Created: Thu Jul 02 06:57:45 2015
...
class Ui_MainDialog(object):
    def setupUi(self, MainDialog):
        ...
        self.widgetBaseLayers.setGeometry(QtCore.QRect(0, 0, 659, 267))
        ...
        self.widgetBaseOverlays.setGeometry(QtCore.QRect(0, 0, 659, 267))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 642, 570))
...
" }"))
        ...
        self.gridLayout_3.addWidget(self.northArrowButton, 1, 0, 1, 1)
